...
<head>
    ...
    <title>SU RESEARCH</title>
    <link rel="stylesheet" href="style.css">
</head>
<body>
    <?php include_once ("templates/nav.php");?>
    <main>
        <section class="research-top">
            <h1>Some Of Our Research Work At Strathmore University</h1>
            <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Saepe veritatis quis voluptate soluta nostrum commodi rem dolore qui modi. Consequuntur quasi harum corporis reprehenderit? Alias velit maiores exercitationem eius dolorem.</p>
        </section>
